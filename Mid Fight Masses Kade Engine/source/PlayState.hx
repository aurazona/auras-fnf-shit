...
class PlayState extends MusicBeatState
{
	...
	var gospelInnerCircle:FlxSprite;
	var gospelOuterCircle:FlxSprite;
	var limo:FlxSprite;
	...
	override public function create()
	{
		...
		switch(SONG.song.toLowerCase())
		{
			...
			case 'parish' | 'worship': //MFM SHIT
				defaultCamZoom = 0.65;
				curStage = 'churchparish';
				//church bg
				var bg:FlxSprite = new FlxSprite(-225, -625/* -600, -350 */).loadGraphic(Paths.image('church1bg'));
				bg.setGraphicSize(0, 2000);
				bg.antialiasing = true;
				bg.scrollFactor.set(0.9, 0.9);
				bg.active = false;
				add(bg);

				var floor:FlxSprite = new FlxSprite(-225, -650/* -650, 400 */).loadGraphic(Paths.image('church1floor'));
				floor.setGraphicSize(0, 2125);
				floor.antialiasing = true;
				floor.scrollFactor.set(1, 1);
				floor.active = false;
				add(floor);

				pillars = new FlxSprite(-225, -650/*-350, -1000*/).loadGraphic(Paths.image('church1pillars'));
				pillars.setGraphicSize(0, 2000);
			...
			case 'zavodila':
				defaultCamZoom = 0.65;
				curStage = 'churchzavodila';
				//church bg
				var bg:FlxSprite = new FlxSprite(-225, -625/* -600, -350 */).loadGraphic(Paths.image('church2bg'));
				bg.setGraphicSize(0, 2000);
				bg.antialiasing = true;
				bg.scrollFactor.set(0.9, 0.9);
				bg.active = false;
				...
				var floor:FlxSprite = new FlxSprite(-225, -750/* -650, 400 */).loadGraphic(Paths.image('church2floor'));
				floor.setGraphicSize(0, 2125);
				floor.antialiasing = true;
				floor.scrollFactor.set(1, 1);
				floor.active = false;
				...
				pillars = new FlxSprite(-225, -750/*-350, -1000*/).loadGraphic(Paths.image('church2pillars'));
				pillars.setGraphicSize(0, 2000);
				pillars.antialiasing = true;
				pillars.scrollFactor.set(1,1);
				pillars.active = false;
			...
			case 'bopeebo' | 'gospel':	
				...
				//church bg
				var bg:FlxSprite = new FlxSprite(-225, -625/* -600, -350 */).loadGraphic(Paths.image('church3bg'));
				bg.setGraphicSize(0, 2000);
				bg.antialiasing = true;
				bg.scrollFactor.set(0.9, 0.9);
				bg.active = false;
				...
				gospelInnerCircle = new FlxSprite(-225, -625).loadGraphic(Paths.image('church3circ1'));
				...
				gospelOuterCircle = new FlxSprite(-225, -625).loadGraphic(Paths.image('church3circ2'));
				gospelOuterCircle.setGraphicSize(0, 2000);
				gospelOuterCircle.antialiasing = true;
				gospelOuterCircle.scrollFactor.set(1, 1);
				add(gospelOuterCircle);

				//demon circle spot things idk what the FUCK they are
				var gospelSymbol:FlxSprite = new FlxSprite(-225, -625).loadGraphic(Paths.image('church3circ0'));
				gospelSymbol.setGraphicSize(0, 2000);
				gospelSymbol.antialiasing = true;
				gospelSymbol.scrollFactor.set(1, 1);
				add(gospelSymbol);

				var floor:FlxSprite = new FlxSprite(-225, -650/* -650, 400 */).loadGraphic(Paths.image('church3floor'));
				floor.setGraphicSize(0, 2125);
				floor.antialiasing = true;
				floor.scrollFactor.set(1, 1);
				floor.active = false;
				...
				pillars = new FlxSprite(-225, -650/*-350, -1000*/).loadGraphic(Paths.image('church3pillars'));
				pillars.setGraphicSize(0, 2000);
				pillars.antialiasing = true;
				pillars.scrollFactor.set(1,1);
				pillars.active = false;
		...
		switch (dad.curCharacter) //CHARACTER HEALTH BAR COLOURS!!!!
		{
			case 'gf':
			...
			case 'parents-christmas':
				healthBar.createFilledBar(0xFFC45EAE, 0xFF31B0D1);
			...
			case 'sarvente' | 'sarvente-dark':
				healthBar.createFilledBar(0xFFF691C5, 0xFF31B0D1);
			case 'ruv':
				healthBar.createFilledBar(0xFF978AA6, 0xFF31B0D1);
			case 'sarvente-evil':
				healthBar.createFilledBar(0xFFDA317D, 0xFF31B0D1);
			default:
		...
		if (generatedMusic)
			{
				...
				{	
					...
					if (!daNote.mustPress && daNote.wasGoodHit)
					{
						...
						switch (Math.abs(daNote.noteData)) //ZAVODILA SCREENSHAKE N SHIT HERE
						{
							case 2:
