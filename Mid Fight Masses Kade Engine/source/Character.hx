...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'sarvente':
				frames = Paths.getSparrowAtlas('sarvente_sheet','shared');
			...
			case 'sarvente-dark':
				frames = Paths.getSparrowAtlas('sarvente_dark','shared');
				...
				animation.addByPrefix('singUP-alt', 'SarvDarkAltUp', 24, false);
				animation.addByPrefix('singDOWN-alt', 'SarvDarkAltDown', 24, false);
				animation.addByPrefix('singLEFT-alt', 'SarvDarkAltLeft', 24, false);
				animation.addByPrefix('singRIGHT-alt', 'SarvDarkAltRight', 24, false);
			...
			case 'ruv':
				frames = Paths.getSparrowAtlas('ruv_sheet','shared');
			...
			case 'sarvente-evil':
				frames = Paths.getSparrowAtlas('sarv-evil','shared');
