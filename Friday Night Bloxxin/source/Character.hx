	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'parents-christmas':
				...
				playAnim('idle');
			case 'NOOBLOL':
				frames = Paths.getSparrowAtlas('NOOBLOL');
				animation.addByPrefix('idle', 'NoobIdle', 24, false);
				animation.addByPrefix('singUP', 'NoobUp', 24, false);
				animation.addByPrefix('singDOWN', 'NoobDown', 24, false);
				animation.addByPrefix('singLEFT', 'NoobLeft', 24, false);
				animation.addByPrefix('singRIGHT', 'NoobRight', 24, false);
